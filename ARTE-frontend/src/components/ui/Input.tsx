...
const Input = forwardRef<HTMLInputElement, InputProps>(({
  ...
  const baseInputClasses = 'block w-full rounded-lg border border-gray-400 bg-white text-black placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-agl-blue';
