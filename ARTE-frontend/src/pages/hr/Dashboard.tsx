...
const HRDashboard: React.FC = () => {
  ...
  const data = {
    ...
    upcomingEndDates: [
      { name: 'Sophie Martin', department: 'Informatique', endDate: '2025-04-15' },
      { name: 'Antoine Fouda', department: 'Génie Civil', endDate: '2025-04-20' },
      { name: 'Paul Biya', department: 'Électromécanique', endDate: '2025-04-30' },
    ],
    recentDocuments: [
      { id: 'DOC-482', type: 'Lettre de stage', student: 'Marie Kamga', date: '2025-03-15', status: 'pending' },
      { id: 'DOC-481', type: 'Attestation', student: 'Lucas Mbappé', date: '2025-03-14', status: 'approved' },
      { id: 'DOC-480', type: 'Lettre de stage', student: 'Jeanne Fouda', date: '2025-03-13', status: 'signed' },
      { id: 'DOC-479', type: 'Attestation', student: 'David Eto\'o', date: '2025-03-12', status: 'sent' },
    ]
  };
